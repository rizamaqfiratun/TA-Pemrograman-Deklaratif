  ...
  <div class="container">
    ...
    <div class="container">
        <div class="modul1">
            ...
            <h3 style="text-align: center">OPERASI LOGIKA EQUAL</h3>
        </div>
        <div style="margin: 100px" class="jawaban">
        ...
        <form action="jawaban4.php" method="POST">
            ...
            <div class="custom-control custom-radio custom-control-inline">
                ...
                <label class="custom-control-label" for="customRadio3">1</label>
            </div>
            <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" class="custom-control-input" id="customRadio4" name="kedua" value="2">
                <label class="custom-control-label" for="customRadio4">0</label>
            </div><br><br><br>
